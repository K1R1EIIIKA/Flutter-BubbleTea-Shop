...
@NonNullApi
public class LabsProjectDependency extends DelegatingProjectDependency {

    @Inject
    public LabsProjectDependency(TypeSafeProjectDependencyFactory factory, ProjectDependencyInternal delegate) {
